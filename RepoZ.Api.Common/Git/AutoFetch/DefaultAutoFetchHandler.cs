    ...
    public class DefaultAutoFetchHandler : IAutoFetchHandler
    {
            ...
            IRepositoryWriter repositoryWriter)
        {
            ...
            _profiles = new Dictionary<AutoFetchMode, AutoFetchProfile>
            {
                ...
                { AutoFetchMode.Once, new AutoFetchProfile() { PauseBetweenFetches = TimeSpan.FromSeconds(2) } },
            };
        ...
        private void FetchNext(object timerState)
        {
            ...
            Console.WriteLine($"Auto-fetching {repositoryView.Name} (index {_lastFetchRepository + 1} of {repositories.Count})");
            ...
            {
                // re-enable the timer to get to the next fetch except in case AutoFetchMode is Once and all repositories have been fetched
                if (_mode == AutoFetchMode.Once && _lastFetchRepository + 1 == repositories.Count)
                {
                    _mode = AutoFetchMode.Off;
                }
